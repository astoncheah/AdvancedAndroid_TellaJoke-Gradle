 ...
 * on 2017-06-20 at 04:52:33 UTC 
 * Modify at your own risk.
 */

package com.example.cheah.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "myApi/v1/setJoke/";
   ...
   * @return the request
   */
  public SetJoke setJoke(java.lang.String name) throws java.io.IOException {
    SetJoke result = new SetJoke(name);
    initialize(result);
    return result;
  }

  public class SetJoke extends MyApiRequest<com.example.cheah.myapplication.backend.myApi.model.MyJokeUtil> {
     ...
     * @since 1.13
     */
    protected SetJoke(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.cheah.myapplication.backend.myApi.model.MyJokeUtil.class);
    ...
    public SetJoke setName(java.lang.String name) {
      this.name = name;
      return this;
    }
